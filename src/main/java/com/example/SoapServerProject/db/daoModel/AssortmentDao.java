...
public class AssortmentDao {
    ...
    public AssortmentDao withId(Integer id) {
        setId(id);
        return this;
    }
    ...
    public AssortmentDao withRoomId(Integer roomId) {
        setRoomId(roomId);
        return this;
    }
    ...
    public AssortmentDao withRoomTv(boolean roomTv) {
        setRoomTv(roomTv);
        return this;
    }
    ...
    public AssortmentDao withRoomBathroom(boolean roomBathroom) {
    ...
    public AssortmentDao withRoomDesk(boolean roomDesk) {
    ...
    public AssortmentDao withRoomSafe(boolean roomSafe) {
    ...
    public AssortmentDao withRoomFridge(boolean roomFridge) {
